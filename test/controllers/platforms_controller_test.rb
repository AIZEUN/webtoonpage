...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { event_id: @platform.event_id, user_id: @platform.user_id } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { event_id: @platform.event_id, user_id: @platform.user_id } }
